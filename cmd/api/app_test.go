...
func TestCreateServer(t *testing.T) {
	...
	assert.Equal(t, ":8080", srv.Addr, "Server address should match port and address")
...
func TestCreateServerWithConfiguredHost(t *testing.T) {
	ctx := context.Background()
	...
	assert.NotNil(t, srv, "Server should not be nil")
	assert.Equal(t, "127.0.0.1:8080", srv.Addr, "Server address should use configured host")
}
